        ...
        for instagram_webpage in instagram_webpages:
            ...
            try:
                self.web_driver.find_element(
                    By.CSS_SELECTOR,
                    "a.x1i10hfl.xjbqb8w.x6umtig.x1b1mbwd.xaqea5y.xav7gou.x9f619.x1ypdohk.xt0psk2.xe8uvvx.xdj266r.x11i5rnm.xat24cr.x1mh8g0r.xexx8yu.x4uap5.x18d9i69.xkhd6sd.x16tdsg8.x1hl2dhg.xggy1nq.x1a2a7pz.x6s0dn4.x78zum5.x1q0g3np.xs83m0k.xeuugli.x1n2onr6._a6hd"
                )
            except:
                logger.error(f"Fail to load. Link: {instagram_webpage.link} is not a page")
                continue
