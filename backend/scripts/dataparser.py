...
def process_post(post_text: str):
    get_info = "Colete informações sobre o evento acima em formato JSON com os valores entre aspas duplas: data, localização, e preço. Nomeie os campos do objeto como date, address e price respectivamente ?\n\n\n"
